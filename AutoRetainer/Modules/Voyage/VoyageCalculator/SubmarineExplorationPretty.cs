...
namespace AutoRetainer.Modules.Voyage.VoyageCalculator
{
    public class SubmarineExplorationPretty : SubmarineExploration
    {
        ...
        public string FancyDestination() => $"[{Svc.Data.GetExcelSheet<SubmarineExplorationPretty>(Dalamud.ClientLanguage.Korean).GetRow(this.RowId).Location}] " + Utils.UpperCaseStr(Destination);
    }
}
